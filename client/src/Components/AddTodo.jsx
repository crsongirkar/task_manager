        ...
        <div className="w-full max-w-md mx-auto">
            <div className="p-4 flex flex-col gap-4 bg-gray-50 rounded-lg shadow-md">
                ...
                <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-green-70 text-white rounded-lg hover:bg-green-800 transition-colors duration-200 font-medium text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                    Add Task
                </button>
            </div>
